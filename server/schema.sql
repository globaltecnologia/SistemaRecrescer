...
SELECT e.id, e.year, st.name AS student_name,
       st.birth_date, st.nationality, st.birthplace,
       e.previous_grade_course_shift,
       st.gender,
       f.name AS father_name,
       COALESCE(f.residential_phone, f.commercial_phone) AS father_phone,
       f.cpf AS father_cpf,
       m.name AS mother_name,
       COALESCE(m.residential_phone, m.commercial_phone) AS mother_phone,
       m.cpf AS mother_cpf,
       e.lives_with,
